(function () {
		...
		bind() {
			...
			this.$input.keypress(function (e) {
				if(e.which == 13 || e.keyCode == 13) {
					this$1.addTag(this$1.$input.val());
					this$1.$input.val('');
				}
			});
	...
	frappe.views.BaseList = class BaseList {
		...
		show() {
			...
			this.init().then(function () { return this$1.refresh(); });
		}
	...
	frappe.views.ListView = class ListView extends frappe.views.BaseList {
		...
		setup_defaults() {
			...
			if (frappe.route_options) {
				...
				var filters = [];
				for (var key in frappe.route_options) {
					var value = frappe.route_options[key];
					if (value.startsWith('[') && value.endsWith(']')) {
						value = JSON.parse(value);
					} else {
						value = ['=', value];
					}
					filters.push([this$1.doctype, key ].concat( value));
				}
				...
				var filters$1 = (this.settings.filters || []).map(function (f) {
					if (f.length === 3) {
		...
		set_filters_from_route_options() {
			...
			this.filter_area.clear(false)
				.then(function () {
					this$1.filter_area.add(filters);
				});
		}
